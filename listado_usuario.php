...
<div class="alert alert-success alert-dismissible fade show" role="alert" id="alertDelete" style="display: none">
  <strong>Usuario eliminado!</strong> Usuario eliminado satisfactoriamente.
...
<span class="h2 p-3">Listado de empleados</span>
<hr />
    ...
    <tbody id="tabla-usuarios">
      <?php foreach ($listaUsuarios as $usuario) { ?>
        <tr>
          ...
          <td>
            <div class="btn-group">
              <button class="btn btn-outline-dark" type="button" data-toggle="modal" <?php echo 'data-target="#modal-' . $usuario->getCodigo() . '"' ?>> <i class="far fa-address-book"></i></button>
        ...
        <div class="modal-body">
          ...
          <div class="card mb-3" style="max-width: 540px;">
            <div class="row no-gutters">
              ...
              <div class="col-md-8">
                <div class="card-body">
                  <h5 class="card-title"><?php echo $usuario->getNombre() ?> <?php echo $usuario->getApellido() ?></h5>
                  </h5>
                  <p class="card-text"><?php echo $usuario->getTelefono() ?></h5>
                  </p>
                  <p class="card-text"><?php echo $usuario->getPuesto() ?></h5>
                  </p>
                  <p class="card-text"><?php echo $usuario->getCorreo() ?></h5>
                  </p>
